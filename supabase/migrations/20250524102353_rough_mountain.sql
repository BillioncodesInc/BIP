/*
  # Database Schema for BillionCodes Initiative Program
  
  This migration creates the core tables and security policies for the application.
  
  1. Tables
    - All core tables for users, content, and operations
...
BEGIN
  ...
  EXECUTE 'ALTER TABLE volunteers ENABLE ROW LEVEL SECURITY';
  EXECUTE 'ALTER TABLE faq_items ENABLE ROW LEVEL SECURITY';
